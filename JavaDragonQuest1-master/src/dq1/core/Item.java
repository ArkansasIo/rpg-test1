...
public class Item {
    ...
    public Item(String serializedData) {
        ...
        itemClass = args.length > 18 ? args[18].trim() : "Basic";
        itemType = args.length > 19 ? args[19].trim() : "Normal";
        attribute = args.length > 20 ? args[20].trim() : "None";
        subtype = args.length > 21 ? args[21].trim() : "None";
        subStat = args.length > 22 ? Integer.parseInt(args[22].trim()) : 0;
    }
