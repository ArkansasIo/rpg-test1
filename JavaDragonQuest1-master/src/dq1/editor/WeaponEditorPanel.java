...
/**
 * Full-detail Weapon Editor Panel for RPG/MMORPG engine.
 */
public class WeaponEditorPanel extends JPanel {
    ...
    public WeaponEditorPanel() {
        ...
        String[] columns = {"ID", "Name", "Buy", "Sell", "ATK", "DEF", "MaxCount", "Class", "Attribute", "Subtype", "SubStat"};
    ...
    private void saveToFile() {
        ...
        chooser.setSelectedFile(new File("weapons.csv"));
