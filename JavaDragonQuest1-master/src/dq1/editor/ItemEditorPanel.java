...
/**
 * Full-detail Item Editor Panel for RPG/MMORPG engine.
 */
public class ItemEditorPanel extends JPanel {
    ...
    public ItemEditorPanel() {
        ...
        String[] columns = {"ID", "Type", "Name", "Buy", "Sell", "ATK", "DEF", "MaxCount", "UseInBattle", "UseInMap", "Disposable", "ItemsPerSlot", "ImmuneToStopSpell", "RelievesHurt", "RelievesBreath", "ProtectsTerrain", "HealPerStep", "Class", "ItemType", "Attribute", "Subtype", "SubStat"};
    ...
    private void saveToFile() {
        ...
        chooser.setSelectedFile(new File("items.csv"));
